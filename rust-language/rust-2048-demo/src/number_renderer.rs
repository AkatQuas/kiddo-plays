...
use opengl_graphics::{GlGraphics, Texture as GlTexture, TextureSettings};
...
impl NumberRenderer {
    pub fn new(mut asset_root: PathBuf) -> NumberRenderer {
        asset_root.push("digits.png");
        NumberRenderer {
            image: GlTexture::from_path(asset_root, &TextureSettings::new()).unwrap(),
        }
    }

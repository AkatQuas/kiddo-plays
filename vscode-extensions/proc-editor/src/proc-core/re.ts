/**
 * @file see https://github.com/benspaulding/vscode-procfile/blob/main/src/core/re.ts
 *
...
export const INTRO = new RegExp(
  re`^(?<name>${name})(?<sep>${sep})(?<blank>${blank})?`
);
 ...
 * See note about the unanchored pattern as to why this exists.
 */

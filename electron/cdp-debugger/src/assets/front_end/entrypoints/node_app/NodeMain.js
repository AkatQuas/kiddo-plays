...
export class NodeChildTargetManager extends SDK.SDKModel.SDKModel {
  ...
  constructor(parentTarget) {
    ...
    this.#childTargets = /* @__PURE__ */ new Map();
    this.#childConnections = /* @__PURE__ */ new Map();
  ...
  attachedToTarget({ sessionId, targetInfo }) {
    ...
    const target = this.#targetManager.createTarget(targetInfo.targetId, name, SDK.Target.Type.Node, this.#parentTarget, void 0, void 0, connection);

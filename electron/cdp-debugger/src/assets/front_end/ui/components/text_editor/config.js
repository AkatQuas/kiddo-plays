...
export function guessIndent(doc) {
  ...
  const shortest = Object.entries(values).reduce((shortest2, [string, count]) => {
    return count < minOccurrence || shortest2 && shortest2.length < string.length ? shortest2 : string;
  }, null);

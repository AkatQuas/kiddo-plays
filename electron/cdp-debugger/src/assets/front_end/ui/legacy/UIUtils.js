...
export function initializeUIUtils(document2) {
  ...
  document2.addEventListener("focus", Utils.focusChanged.bind(void 0), true);
...
export class CheckboxLabel extends HTMLSpanElement {
  ...
  constructor() {
    ...
    this.shadowRootInternal = Utils.createShadowRootWithCoreStyles(this, { cssFile: checkboxTextLabelStyles, delegatesFocus: void 0 });
...
export class DevToolsRadioButton extends HTMLSpanElement {
  ...
  constructor() {
    ...
    const root = Utils.createShadowRootWithCoreStyles(this, { cssFile: radioButtonStyles, delegatesFocus: void 0 });
    root.createChild("slot");
...
export class DevToolsSlider extends HTMLSpanElement {
  ...
  constructor() {
    super();
    const root = Utils.createShadowRootWithCoreStyles(this, { cssFile: sliderStyles, delegatesFocus: void 0 });
...
export class DevToolsSmallBubble extends HTMLSpanElement {
  ...
  constructor() {
    super();
    const root = Utils.createShadowRootWithCoreStyles(this, { cssFile: smallBubbleStyles, delegatesFocus: void 0 });
...
export class DevToolsCloseButton extends HTMLDivElement {
  ...
  constructor() {
    super();
    const root = Utils.createShadowRootWithCoreStyles(this, { cssFile: closeButtonStyles, delegatesFocus: void 0 });
...
export class MessageDialog {
  static async show(message, where) {
    ...
    const shadowRoot = Utils.createShadowRootWithCoreStyles(dialog.contentElement, { cssFile: confirmDialogStyles, delegatesFocus: void 0 });
...
export class ConfirmDialog {
  static async show(message, where) {
    ...
    const result = await new Promise((resolve) => {
      const okButton = createTextButton(i18nString(UIStrings.ok), () => resolve(true), "", true);
...
export function createInlineButton(toolbarButton) {
  ...
  const shadowRoot = Utils.createShadowRootWithCoreStyles(element, { cssFile: inlineButtonStyles, delegatesFocus: void 0 });

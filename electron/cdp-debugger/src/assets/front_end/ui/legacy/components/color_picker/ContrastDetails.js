...
export class ContrastDetails extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(contrastInfo, contentElement, toggleMainColorPickerCallback, expandedChangedCallback, colorSelectedCallback) {
    ...
    this.bgColorPickerButton = new UI.Toolbar.ToolbarToggle(i18nString(UIStrings.toggleBackgroundColorPicker), "largeicon-eyedropper");
    this.bgColorPickerButton.addEventListener(UI.Toolbar.ToolbarButton.Events.Click, this.toggleBackgroundColorPickerInternal.bind(this, void 0, true));
  ...
  computeSuggestedColor(threshold) {
    ...
    if (threshold === "APCA") {
      ...
      return Common.Color.Color.findFgColorForContrastAPCA(fgColor, bgColor, requiredContrast2 + 1);
    }
  ...
  createFixColorButton(parent, suggestedColor) {
    ...
    const colorFormat = originalColorFormat && originalColorFormat !== Common.Color.Format.Nickname && originalColorFormat !== Common.Color.Format.Original ? originalColorFormat : Common.Color.Format.HEXA;
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["BackgroundColorPickerWillBeToggled"] = "BackgroundColorPickerWillBeToggled";
  return Events2;
})(Events || {});
export class Swatch {
  parentElement;

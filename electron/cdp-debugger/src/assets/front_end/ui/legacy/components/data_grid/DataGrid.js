...
const elementToSortIconMap = /* @__PURE__ */ new WeakMap();
...
export class DataGridImpl extends Common.ObjectWrapper.ObjectWrapper {
  ...
  setName(name) {
    this.columnWeightsSetting = Common.Settings.Settings.instance().createSetting("dataGrid-" + name + "-columnWeights", {});
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["SelectedNode"] = "SelectedNode";
  Events2["DeselectedNode"] = "DeselectedNode";
  Events2["OpenedNode"] = "OpenedNode";
  Events2["SortingChanged"] = "SortingChanged";
  Events2["PaddingChanged"] = "PaddingChanged";
  return Events2;
})(Events || {});
...
export class DataGridNode {
  ...
  expand() {
    ...
    if (this.selected && this.dataGrid) {
      this.dataGrid.updateGridAccessibleName(i18nString(UIStrings.expanded));
    }
  ...
  select(supressSelectedEvent) {
    ...
    if (!supressSelectedEvent) {
      this.dataGrid.dispatchEventToListeners("SelectedNode" /* SelectedNode */, this);
    }
  }
  revealAndSelect() {
    if (this.isRoot) {
  ...
  deselect(supressDeselectedEvent) {
    ...
    if (!supressDeselectedEvent) {
      this.dataGrid.dispatchEventToListeners("DeselectedNode" /* DeselectedNode */);
    }
  }

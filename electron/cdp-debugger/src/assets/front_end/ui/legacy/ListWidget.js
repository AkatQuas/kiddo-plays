...
export class Editor {
  ...
  constructor() {
    ...
    this.commitButton = createTextButton("", this.commitClicked.bind(this), "", true);
    buttonsRow.appendChild(this.commitButton);
    this.cancelButton = createTextButton(i18nString(UIStrings.cancelString), this.cancelClicked.bind(this), "", true);

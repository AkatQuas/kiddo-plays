...
export class TreeOutlineInShadow extends TreeOutline {
  ...
  constructor() {
    ...
    this.shadowRoot = Utils.createShadowRootWithCoreStyles(this.element, { cssFile: treeoutlineStyles, delegatesFocus: void 0 });
...
export class TreeElement {
  ...
  set hidden(x) {
    ...
    if (x && this.treeOutline && this.treeOutline.selectedTreeElement && this.treeOutline.selectedTreeElement.hasAncestorOrSelf(this)) {
      ...
      this.treeOutline.forceSelect(!hadFocus, false);
    }
  }
  invalidateChildren() {
    if (this.childrenInternal) {

(function() {
  ...
  diff_match_patch.prototype.diff_main = function(a, b, c, d) {
    typeof d == "undefined" && (d = 0 >= this.Diff_Timeout ? Number.MAX_VALUE : new Date().getTime() + 1e3 * this.Diff_Timeout);
    if (a == null || b == null)
  ...
  diff_match_patch.prototype.diff_compute_ = function(a, b, c, d) {
    ...
    return g != -1 ? (c = [[1, e.substring(0, g)], [0, f], [1, e.substring(g + f.length)]], a.length > b.length && (c[0][0] = c[2][0] = -1), c) : f.length == 1 ? [[-1, a], [1, b]] : (e = this.diff_halfMatch_(a, b)) ? (f = e[0], a = e[1], g = e[2], b = e[3], e = e[4], f = this.diff_main(f, g, c, d), c = this.diff_main(a, b, c, d), f.concat([[0, e]], c)) : c && 100 < a.length && 100 < b.length ? this.diff_lineMode_(a, b, d) : this.diff_bisect_(a, b, d);
  };
    ...
    for (var k = d - e, q = k % 2 != 0, r = 0, t = 0, p = 0, w = 0, v = 0; v < f && !(new Date().getTime() > c); v++) {
      for (var n = -v + r; n <= v - t; n += 2) {
        ...
        if (m > d)
          ...
          r += 2;
        else if (q && (l = g + k - n, 0 <= l && l < h && i[l] != -1)) {
          var u = d - i[l];
          if (m >= u)
      ...
      for (n = -v + p; n <= v - w; n += 2) {
        ...
        if (u > d)
          ...
          p += 2;
        else if (!q && (l = g + k - n, 0 <= l && (l < h && j[l] != -1) && (m = j[l], s = g + m - l, u = d - u, m >= u)))
          return this.diff_bisectSplit_(a, b, m, s, c);
      }
    }
    return [[-1, a], [1, b]];
  ...
  diff_match_patch.prototype.diff_linesToChars_ = function(a, b) {
    function c(a2) {
      for (var b2 = "", c2 = 0, f2 = -1, g2 = d.length; f2 < a2.length - 1; ) {
        ...
        (e.hasOwnProperty ? e.hasOwnProperty(r) : e[r] !== void 0) ? b2 += String.fromCharCode(e[r]) : (b2 += String.fromCharCode(g2), e[r] = g2, d[g2++] = r);
      }
      return b2;
    }
    var d = [], e = {};
  ...
  diff_match_patch.prototype.diff_commonOverlap_ = function(a, b) {
    ...
    for (var d = 0, e = 1; ; ) {
      ...
      if (f == -1)
        return d;
      e += f;
      if (f == 0 || a.substring(c - e) == b.substring(0, e))
        d = e, e++;
    }
  };
  diff_match_patch.prototype.diff_halfMatch_ = function(a, b) {
    function c(a2, b2, c2) {
      for (var d2 = a2.substring(c2, c2 + Math.floor(a2.length / 4)), e2 = -1, g2 = "", h2, j2, n, l; (e2 = b2.indexOf(d2, e2 + 1)) != -1; ) {
  ...
  diff_match_patch.prototype.diff_cleanupSemantic = function(a) {
    for (var b = false, c = [], d = 0, e = null, f = 0, g = 0, h = 0, j = 0, i = 0; f < a.length; )
      a[f][0] == 0 ? (c[d++] = f, g = j, h = i, i = j = 0, e = a[f][1]) : (a[f][0] == 1 ? j += a[f][1].length : i += a[f][1].length, e && (e.length <= Math.max(g, h) && e.length <= Math.max(j, i)) && (a.splice(c[d - 1], 0, [-1, e]), a[c[d - 1] + 1][0] = 1, d--, d--, f = 0 < d ? c[d - 1] : -1, i = j = h = g = 0, e = null, b = true)), f++;
  ...
  diff_match_patch.prototype.diff_cleanupEfficiency = function(a) {
    for (var b = false, c = [], d = 0, e = null, f = 0, g = false, h = false, j = false, i = false; f < a.length; ) {
      ...
      else if (a[f][0] == -1 ? i = true : j = true, e && (g && h && j && i || e.length < this.Diff_EditCost / 2 && g + h + j + i == 3))
    ...
    for (var b = 0, c = 0, d = 0, e = "", f = "", g; b < a.length; )
      switch (a[b][0]) {
        ...
        case -1:
          ...
          break;
        case 0:
          1 < c + d ? (c !== 0 && d !== 0 && (g = this.diff_commonPrefix(f, e), g !== 0 && (0 < b - c - d && a[b - c - d - 1][0] == 0 ? a[b - c - d - 1][1] += f.substring(0, g) : (a.splice(0, 0, [0, f.substring(0, g)]), b++), f = f.substring(g), e = e.substring(g)), g = this.diff_commonSuffix(f, e), g !== 0 && (a[b][1] = f.substring(f.length - g) + a[b][1], f = f.substring(0, f.length - g), e = e.substring(0, e.length - g))), c === 0 ? a.splice(b - d, c + d, [1, f]) : d === 0 ? a.splice(b - c, c + d, [-1, e]) : a.splice(b - c - d, c + d, [-1, e], [1, f]), b = b - c - d + (c ? 1 : 0) + (d ? 1 : 0) + 1) : b !== 0 && a[b - 1][0] == 0 ? (a[b - 1][1] += a[b][1], a.splice(b, 1)) : b++, c = d = 0, f = e = "";
      }
    a[a.length - 1][1] === "" && a.pop();
    c = false;
    for (b = 1; b < a.length - 1; )
      a[b - 1][0] == 0 && a[b + 1][0] == 0 && (a[b][1].substring(a[b][1].length - a[b - 1][1].length) == a[b - 1][1] ? (a[b][1] = a[b - 1][1] + a[b][1].substring(0, a[b][1].length - a[b - 1][1].length), a[b + 1][1] = a[b - 1][1] + a[b + 1][1], a.splice(b - 1, 1), c = true) : a[b][1].substring(0, a[b + 1][1].length) == a[b + 1][1] && (a[b - 1][1] += a[b + 1][1], a[b][1] = a[b][1].substring(a[b + 1][1].length) + a[b + 1][1], a.splice(b + 1, 1), c = true)), b++;
  ...
  diff_match_patch.prototype.match_bitap_ = function(a, b, c) {
    ...
    for (var j = 1 << b.length - 1, h = -1, i, k, q = b.length + a.length, r, t = 0; t < b.length; t++) {
      ...
      for (k[p + 1] = (1 << t) - 1; p >= i; p--) {
        ...
        k[p] = t === 0 ? (k[p + 1] << 1 | 1) & w : (k[p + 1] << 1 | 1) & w | ((r[p + 1] | r[p]) << 1 | 1) | r[p + 1];
  ...
  diff_match_patch.prototype.patch_make = function(a, b, c) {
    ...
    else if (typeof a == "string" && b && typeof b == "object" && typeof c == "undefined")
      d = a;
    else if (typeof a == "string" && typeof b == "string" && c && typeof c == "object")
      d = a, b = c;
    else
  ...
  diff_match_patch.prototype.patch_apply = function(a, b) {
    ...
    for (var d = 0, e = [], f = 0; f < a.length; f++) {
      ...
      if (h.length > this.Match_MaxBits) {
        if (j = this.match_main(b, h.substring(0, this.Match_MaxBits), g), j != -1 && (i = this.match_main(b, h.substring(h.length - this.Match_MaxBits), g + h.length - this.Match_MaxBits), i == -1 || j >= i))
          j = -1;
      } else
        j = this.match_main(b, h, g);
      if (j == -1)
        e[f] = false, d -= a[f].length2 - a[f].length1;
      else if (e[f] = true, d = j - g, g = i == -1 ? b.substring(j, j + h.length) : b.substring(j, i + this.Match_MaxBits), h == g)
        ...
        for (var h = 0, k, i = 0; i < a[f].diffs.length; i++) {
          ...
          q[0] === 1 ? b = b.substring(0, j + k) + q[1] + b.substring(j + k) : q[0] === -1 && (b = b.substring(0, j + k) + b.substring(j + this.diff_xIndex(g, h + q[1].length)));
          q[0] !== -1 && (h += q[1].length);
        }
      }
    }
  ...
  diff_match_patch.prototype.patch_addPadding = function(a) {
    ...
    d = a[a.length - 1];
    e = d.diffs;
    e.length == 0 || e[e.length - 1][0] != 0 ? (e.push([
      0,
      c
      ...
      if (!(a[c].length1 <= b)) {
        ...
        for (var e = d.start1, f = d.start2, g = ""; d.diffs.length !== 0; ) {
          ...
          for (; d.diffs.length !== 0 && h.length1 < b - this.Patch_Margin; ) {
            ...
            g === 1 ? (h.length2 += i.length, f += i.length, h.diffs.push(d.diffs.shift()), j = false) : g === -1 && h.diffs.length == 1 && h.diffs[0][0] == 0 && i.length > 2 * b ? (h.length1 += i.length, e += i.length, j = false, h.diffs.push([g, i]), d.diffs.shift()) : (i = i.substring(0, b - h.length1 - this.Patch_Margin), h.length1 += i.length, e += i.length, g === 0 ? (h.length2 += i.length, f += i.length) : j = false, h.diffs.push([g, i]), i == d.diffs[0][1] ? d.diffs.shift() : d.diffs[0][1] = d.diffs[0][1].substring(i.length));
          }
          g = this.diff_text2(h.diffs);
          g = g.substring(g.length - this.Patch_Margin);
          i = this.diff_text1(d.diffs).substring(0, this.Patch_Margin);
          i !== "" && (h.length1 += i.length, h.length2 += i.length, h.diffs.length !== 0 && h.diffs[h.diffs.length - 1][0] === 0 ? h.diffs[h.diffs.length - 1][1] += i : h.diffs.push([0, i]));
          j || a.splice(++c, 0, h);
        }
      }
  };
  ...
  diff_match_patch.prototype.patch_fromText = function(a) {
    ...
    for (var c = 0, d = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; c < a.length; ) {
      ...
      e[4] === "" ? (f.start2--, f.length2 = 1) : e[4] == "0" ? f.length2 = 0 : (f.start2--, f.length2 = parseInt(e[4], 10));
      for (c++; c < a.length; ) {
        e = a[c].charAt(0);
        try {

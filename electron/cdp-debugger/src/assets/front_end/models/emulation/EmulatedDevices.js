...
export class EmulatedDevice {
  ...
  static fromJSONV1(json) {
    try {
      let parseValue = function(object, key, type, defaultValue) {
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["CustomDevicesUpdated"] = "CustomDevicesUpdated";
  Events2["StandardDevicesUpdated"] = "StandardDevicesUpdated";
  return Events2;
})(Events || {});

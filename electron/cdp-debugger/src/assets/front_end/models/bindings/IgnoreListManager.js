...
export class IgnoreListManager {
  ...
  constructor(debuggerWorkspaceBinding) {
    ...
    Common.Settings.Settings.instance().moduleSetting("skipStackFramesPattern").addChangeListener(this.patternChanged.bind(this));
    Common.Settings.Settings.instance().moduleSetting("skipContentScripts").addChangeListener(this.patternChanged.bind(this));
  ...
  ignoreListURL(url) {
    ...
    if (!found) {
      regexPatterns.push({ pattern: regexValue, disabled: void 0 });
    }

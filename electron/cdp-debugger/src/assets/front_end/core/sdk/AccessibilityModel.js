...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["TreeUpdated"] = "TreeUpdated";
  return Events2;
})(Events || {});
export class AccessibilityModel extends SDKModel {
  ...
  loadComplete({ root }) {
    ...
    this.dispatchEventToListeners("TreeUpdated" /* TreeUpdated */, { root: this.#root });
  }
  nodesUpdated({ nodes }) {
    this.createNodesFromPayload(nodes);
    this.dispatchEventToListeners("TreeUpdated" /* TreeUpdated */, {});
    return;
  }

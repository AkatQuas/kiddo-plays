...
export class OverlayModel extends SDKModel {
  ...
  constructor(target) {
    ...
    if (this.#debuggerModel) {
      Common.Settings.Settings.instance().moduleSetting("disablePausedStateOverlay").addChangeListener(this.updatePausedInDebuggerMessage, this);
    ...
    this.#showScrollBottleneckRectsSetting = Common.Settings.Settings.instance().moduleSetting("showScrollBottleneckRects");
  ...
  updatePausedInDebuggerMessage() {
    ...
    const message = this.#debuggerModel && this.#debuggerModel.isPaused() && !Common.Settings.Settings.instance().moduleSetting("disablePausedStateOverlay").get() ? i18nString(UIStrings.pausedInDebugger) : void 0;
  ...
  buildHighlightConfig(mode = "all", showDetailedToolip = false) {
    ...
    const supportedColorFormats = /* @__PURE__ */ new Set(["rgb", "hsl", "hex"]);
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["InspectModeWillBeToggled"] = "InspectModeWillBeToggled";
  Events2["ExitedInspectMode"] = "InspectModeExited";
  Events2["HighlightNodeRequested"] = "HighlightNodeRequested";
  Events2["ScreenshotRequested"] = "ScreenshotRequested";
  Events2["PersistentGridOverlayStateChanged"] = "PersistentGridOverlayStateChanged";
  Events2["PersistentFlexContainerOverlayStateChanged"] = "PersistentFlexContainerOverlayStateChanged";
  Events2["PersistentScrollSnapOverlayStateChanged"] = "PersistentScrollSnapOverlayStateChanged";
  Events2["PersistentContainerQueryOverlayStateChanged"] = "PersistentContainerQueryOverlayStateChanged";
  return Events2;
})(Events || {});

...
export class ResourceTreeModel extends SDKModel {
  ...
  constructor(target) {
    ...
    this.#pendingPrerenderAttemptCompletedEvents = /* @__PURE__ */ new Set();
...
export var Events = /* @__PURE__ */ ((Events2) => {
  ...
  Events2["MainFrameNavigated"] = "MainFrameNavigated";
  ...
  Events2["PrerenderingStatusUpdated"] = "PrerenderingStatusUpdated";
  return Events2;
})(Events || {});
...
export class PageDispatcher {
  ...
  loadEventFired({ timestamp }) {
    this.#resourceTreeModel.dispatchEventToListeners("Load" /* Load */, { resourceTreeModel: this.#resourceTreeModel, loadTime: timestamp });
  }

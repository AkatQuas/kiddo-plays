...
export class HeapProfilerModel extends SDKModel {
  ...
  lastSeenObjectId(lastSeenObjectId, timestamp) {
    this.dispatchEventToListeners(Events.LastSeenObjectId, { lastSeenObjectId, timestamp });
  }
  ...
  reportHeapSnapshotProgress(done, total, finished) {
    this.dispatchEventToListeners(Events.ReportHeapSnapshotProgress, { done, total, finished });
  }
  resetProfiles() {
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["HeapStatsUpdate"] = "HeapStatsUpdate";
  Events2["LastSeenObjectId"] = "LastSeenObjectId";
  Events2["AddHeapSnapshotChunk"] = "AddHeapSnapshotChunk";
  Events2["ReportHeapSnapshotProgress"] = "ReportHeapSnapshotProgress";
  Events2["ResetProfiles"] = "ResetProfiles";
  return Events2;
})(Events || {});

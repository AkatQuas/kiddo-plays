...
export class Color {
  ...
  static parse(text) {
    ...
    if (match) {
      ...
      const hasAlpha = values[3] !== void 0;
      if (match[1]) {
        const rgba = [
  ...
  static desiredLuminance(luminance2, contrast, lighter) {
  ...
  static findFgColorForContrast(fgColor, bgColor, requiredContrast) {
    ...
    const candidateLuminance = (candidateHSVA2) => {
      return luminance(blendColors(Color.fromHSVA(candidateHSVA2).rgba(), bgRGBA));
    };
  ...
  static findFgColorForContrastAPCA(fgColor, bgColor, requiredContrast) {
    ...
    const bgRGBA = bgColor.rgba();
    const candidateLuminance = (candidateHSVA2) => {
      return luminanceAPCA(Color.fromHSVA(candidateHSVA2).rgba());
    };
...
export const PageHighlight = {
  Content: Color.fromRGBA([111, 168, 220, 0.66]),
  ContentLight: Color.fromRGBA([111, 168, 220, 0.5]),
  ContentOutline: Color.fromRGBA([9, 83, 148]),
  Padding: Color.fromRGBA([147, 196, 125, 0.55]),
  PaddingLight: Color.fromRGBA([147, 196, 125, 0.4]),
  Border: Color.fromRGBA([255, 229, 153, 0.66]),
  BorderLight: Color.fromRGBA([255, 229, 153, 0.5]),
  Margin: Color.fromRGBA([246, 178, 107, 0.66]),
  MarginLight: Color.fromRGBA([246, 178, 107, 0.5]),
  EventTarget: Color.fromRGBA([255, 196, 196, 0.66]),
  Shape: Color.fromRGBA([96, 82, 177, 0.8]),
  ShapeMargin: Color.fromRGBA([96, 82, 127, 0.6]),
  CssGrid: Color.fromRGBA([75, 0, 130, 1]),
  LayoutLine: Color.fromRGBA([...LAYOUT_LINES_HIGHLIGHT_COLOR, 1]),
  GridBorder: Color.fromRGBA([...LAYOUT_LINES_HIGHLIGHT_COLOR, 1]),
  GapBackground: Color.fromRGBA([...LAYOUT_LINES_HIGHLIGHT_COLOR, 0.3]),
  GapHatch: Color.fromRGBA([...LAYOUT_LINES_HIGHLIGHT_COLOR, 0.8]),

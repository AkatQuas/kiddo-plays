...
export class Settings {
  constructor(syncedStorage, globalStorage, localStorage) {
    ...
    for (const registration of getRegisteredSettings()) {
      ...
      const setting = isRegex && typeof defaultValue === "string" ? this.createRegExpSetting(settingName, defaultValue, void 0, storageType) : this.createSetting(settingName, defaultValue, storageType);

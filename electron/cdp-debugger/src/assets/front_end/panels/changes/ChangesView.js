...
export class ChangesView extends UI.Widget.VBox {
  ...
  constructor() {
    super(true);
    const splitWidget = new UI.SplitWidget.SplitWidget(true, false);
  ...
  click(event) {
    ...
    for (const target of event.composedPath()) {
      ...
      if (target.classList.contains("diff-line-content") && target.hasAttribute("data-line-number")) {
        ...
        if (Root.Runtime.experiments.isEnabled(Root.Runtime.ExperimentName.PRECISE_CHANGES) && this.#selectedSourceCodeFormattedMapping) {

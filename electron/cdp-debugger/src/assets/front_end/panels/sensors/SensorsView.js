...
export class SensorsView extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.deviceOrientationSetting = Common.Settings.Settings.instance().createSetting("emulation.deviceOrientationOverride", "");
  ...
  applyDeviceOrientationUserInput() {
    this.setDeviceOrientation(SDK.EmulationModel.DeviceOrientation.parseUserInput(this.alphaElement.value.trim(), this.betaElement.value.trim(), this.gammaElement.value.trim()), DeviceOrientationModificationSource.UserInput);
    this.setSelectElementLabel(this.orientationSelectElement, NonPresetOptions.Custom);
  }
  resetDeviceOrientation() {
    this.setDeviceOrientation(new SDK.EmulationModel.DeviceOrientation(0, 90, 0), DeviceOrientationModificationSource.ResetButton);
  ...
  createAxisInput(parentElement, input, label, validator) {
    ...
    div.appendChild(UI.UIUtils.createLabel(label, "", input));
...
export var DeviceOrientationModificationSource = /* @__PURE__ */ ((DeviceOrientationModificationSource2) => {
  DeviceOrientationModificationSource2["UserInput"] = "userInput";
  DeviceOrientationModificationSource2["UserDrag"] = "userDrag";
  DeviceOrientationModificationSource2["ResetButton"] = "resetButton";
  DeviceOrientationModificationSource2["SelectPreset"] = "selectPreset";

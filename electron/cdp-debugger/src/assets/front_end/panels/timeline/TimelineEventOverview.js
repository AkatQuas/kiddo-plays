...
export class TimelineEventOverviewInput extends TimelineEventOverview {
  ...
  update() {
    ...
    const descriptorsByType = /* @__PURE__ */ new Map();
    let maxPriority = -1;
...
export class TimelineEventOverviewNetwork extends TimelineEventOverview {
  ...
  update() {
    ...
    const highPrioritySet = /* @__PURE__ */ new Set([
...
const categoryToIndex = /* @__PURE__ */ new WeakMap();
  ...
  update() {
    ...
    function drawThreadEvents(ctx, events) {
      ...
      function onEventEnd(e) {
        ...
        if (e.endTime !== void 0 && lastCategoryIndex) {
      ...
      quantizer.appendInterval(timeOffset + timeSpan + quantTime, idleIndex);
...
export class TimelineEventOverviewCoverage extends TimelineEventOverview {
  ...
  update() {
    ...
    let total = 0;
    let total_used = 0;
    const usedByTimestamp = /* @__PURE__ */ new Map();
    const totalByTimestamp = /* @__PURE__ */ new Map();
    for (const urlInfo of this.coverageModel.entries()) {
      for (const info of urlInfo.entries()) {
        ...
        for (const [stamp, used] of info.usedByTimestamp()) {
          ...
          if (uniqueTimestamps === void 0) {
            uniqueTimestamps = /* @__PURE__ */ new Set();
    ...
    const coverageByTimestamp = /* @__PURE__ */ new Map();

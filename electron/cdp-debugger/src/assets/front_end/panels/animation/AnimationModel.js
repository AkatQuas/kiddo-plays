...
export class AnimationImpl {
  ...
  constructor(animationModel, payload) {
    ...
    this.#sourceInternal = new AnimationEffect(animationModel, this.#payloadInternal.source);
  }
...
export class ScreenshotCapture {
  ...
  captureScreenshots(duration, screenshots) {
    ...
    this.#capturing = true;
    this.#screenCaptureModel.startScreencast(Protocol.Page.StartScreencastRequestFormat.Jpeg, 80, void 0, 300, 2, this.screencastFrame.bind(this), (_visible) => {
    });
  }

...
export class CookieItemsView extends StorageItemsView {
  ...
  constructor(model, cookieDomain) {
    ...
    this.totalSize = 0;
    this.cookiesTable = new CookieTable.CookiesTable.CookiesTable(false, this.saveCookie.bind(this), this.refreshItems.bind(this), this.handleCookieSelected.bind(this), this.deleteCookie.bind(this));
    this.cookiesTable.setMinimumSize(0, 50);
    this.splitWidget = new UI.SplitWidget.SplitWidget(false, true, "cookieItemsSplitViewState");

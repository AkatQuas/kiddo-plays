...
export class ApplicationPanelSidebar extends UI.Widget.VBox {
  ...
  constructor(panel) {
    ...
    this.localStorageListTreeElement = new ExpandableApplicationPanelTreeElement(panel, i18nString(UIStrings.localStorage), "LocalStorage");
    ...
    this.sessionStorageListTreeElement = new ExpandableApplicationPanelTreeElement(panel, i18nString(UIStrings.sessionStorage), "SessionStorage");
    ...
    this.databasesListTreeElement = new ExpandableApplicationPanelTreeElement(panel, i18nString(UIStrings.webSql), "Databases");
    ...
    this.cookieListTreeElement = new ExpandableApplicationPanelTreeElement(panel, i18nString(UIStrings.cookies), "Cookies");
    ...
    this.databaseTableViews = /* @__PURE__ */ new Map();
    this.databaseQueryViews = /* @__PURE__ */ new Map();
    this.databaseTreeElements = /* @__PURE__ */ new Map();
  ...
  async updateDatabaseTables(event) {
    ...
    const tableNamesHash = /* @__PURE__ */ new Set();
...
export class IDBIndexTreeElement extends ApplicationPanelTreeElement {
  ...
  get itemURL() {
    return "indexedDB://" + this.databaseId.securityOrigin + "/" + this.databaseId.name + "/" + this.objectStore.name + "/" + this.index.name;
  }
  markNeedsRefresh() {
    if (this.view) {
      this.view.markNeedsRefresh();
...
export class DOMStorageTreeElement extends ApplicationPanelTreeElement {
  ...
  constructor(storagePanel, domStorage) {
    super(storagePanel, domStorage.securityOrigin ? domStorage.securityOrigin : domStorage.storageKey ? domStorage.storageKey : i18nString(UIStrings.localFiles), false);

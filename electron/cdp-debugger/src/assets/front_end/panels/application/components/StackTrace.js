    ...
    LitHtml.render(LitHtml.html`
      <div class="stack-trace-row">
              ...
              <div class="stack-trace-source-location">
                ${this.#stackTraceRowItem.link ? LitHtml.html`<div class="text-ellipsis">\xA0@\xA0${this.#stackTraceRowItem.link}</div>` : LitHtml.nothing}
              </div>
            </div>
...
export class StackTrace extends HTMLElement {
  ...
  createRowTemplates() {
    ...
    if (hiddenCallFramesCount) {
      expandableRows.push(LitHtml.html`
      <${StackTraceLinkButton.litTagName} data-stack-trace-row .data=${{ onShowAllClick: this.#onShowAllClick.bind(this), hiddenCallFramesCount }}></${StackTraceLinkButton.litTagName}>
      `);
    }

...
const adjacencyMap = /* @__PURE__ */ new WeakMap();
...
export class HeapSnapshotSortableDataGrid extends Common.ObjectWrapper.eventMixin(HeapSnapshotSortableDataGridBase) {
  ...
  populateContextMenu(contextMenu, gridNode) {
    ...
    if (node instanceof HeapSnapshotGenericObjectNode && node.linkElement && !contextMenu.containsTarget(node.linkElement)) {
...
export var HeapSnapshotSortableDataGridEvents = /* @__PURE__ */ ((HeapSnapshotSortableDataGridEvents2) => {
...
export var HeapSnapshotRetainmentDataGridEvents = /* @__PURE__ */ ((HeapSnapshotRetainmentDataGridEvents2) => {
...
export class HeapSnapshotDiffDataGrid extends HeapSnapshotViewportDataGrid {
  ...
  async populateChildren() {
    if (this.snapshot === null || this.baseSnapshot === void 0 || this.baseSnapshot.uid === void 0) {

...
export class HeapSnapshotGenericObjectNode extends HeapSnapshotGridNode {
  ...
  async queryObjectContent(heapProfilerModel, objectGroupName) {
    ...
    return remoteObject || heapProfilerModel.runtimeModel().createRemoteObjectFromPrimitiveValue(i18nString(UIStrings.previewIsNotAvailable));
  }
...
export class HeapSnapshotObjectNode extends HeapSnapshotGenericObjectNode {
  ...
  retainersDataSource() {
    return this.snapshotNodeIndex === void 0 ? null : { snapshot: this.snapshot, snapshotNodeIndex: this.snapshotNodeIndex };
  }
  createProvider() {
...
export class HeapSnapshotInstanceNode extends HeapSnapshotGenericObjectNode {
  ...
  retainersDataSource() {
    return this.snapshotNodeIndex === void 0 ? null : { snapshot: this.baseSnapshotOrSnapshot, snapshotNodeIndex: this.snapshotNodeIndex };
  }
  createProvider() {
    if (this.snapshotNodeIndex === void 0) {
      throw new Error("Cannot create providers on root nodes");
...
export class HeapSnapshotDiffNode extends HeapSnapshotGridNode {
  ...
  createProvider() {
    ...
    if (tree.snapshot === null || tree.baseSnapshot === void 0 || tree.baseSnapshot.uid === void 0) {

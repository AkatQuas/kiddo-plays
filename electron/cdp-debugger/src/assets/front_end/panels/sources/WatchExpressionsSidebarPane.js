...
export class WatchExpressionsSidebarPane extends UI.ThrottledWidget.ThrottledWidget {
  ...
  constructor() {
    ...
    this.watchExpressionsSetting = Common.Settings.Settings.instance().createLocalSetting("watchExpressions", []);
    ...
    this.refreshButton = new UI.Toolbar.ToolbarButton(i18nString(UIStrings.refreshWatchExpressions), "largeicon-refresh");
...
export class WatchExpression extends Common.ObjectWrapper.ObjectWrapper {
  ...
  update() {
    ...
    if (currentExecutionContext && this.expressionInternal) {
      void currentExecutionContext.evaluate({
  ...
  createWatchExpressionHeader(expressionValue, exceptionDetails) {
    ...
    this.nameElement = ObjectUI.ObjectPropertiesSection.ObjectPropertiesSection.createNameElement(this.expressionInternal);
    if (Boolean(exceptionDetails) || !expressionValue) {
      ...
      if (exceptionDetails !== void 0 && exceptionDetails.exception !== void 0 && exceptionDetails.exception.description !== void 0) {
        UI.Tooltip.Tooltip.install(this.valueElement, exceptionDetails.exception.description);
      }
    } else {
      const propertyValue = ObjectUI.ObjectPropertiesSection.ObjectPropertiesSection.createPropertyValueWithCustomSupport(expressionValue, Boolean(exceptionDetails), false, titleElement, this.linkifier);
...
var Events = /* @__PURE__ */ ((Events2) => {
  Events2["ExpressionUpdated"] = "ExpressionUpdated";
  return Events2;
})(Events || {});

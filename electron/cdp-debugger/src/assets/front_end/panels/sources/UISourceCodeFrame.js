...
export class UISourceCodeFrame extends Common.ObjectWrapper.eventMixin(SourceFrame.SourceFrame.SourceFrameImpl) {
  ...
  constructor(uiSourceCode) {
    ...
    Common.Settings.Settings.instance().moduleSetting("persistenceNetworkOverridesEnabled").addChangeListener(this.onNetworkPersistenceChanged, this);
    this.errorPopoverHelper = new UI.PopoverHelper.PopoverHelper(this.textEditor.editor.contentDOM, this.getErrorPopoverContent.bind(this));
  ...
  initializeUISourceCode() {
    ...
    if (Root.Runtime.experiments.isEnabled("sourcesPrettyPrint")) {
      const supportedPrettyTypes = /* @__PURE__ */ new Set(["text/html", "text/css", "text/javascript"]);
  ...
  canEditSourceInternal() {
    ...
    if (this.uiSourceCodeInternal.project().type() === Workspace.Workspace.projectTypes.Network && Persistence.NetworkPersistenceManager.NetworkPersistenceManager.instance().active()) {
      return true;
    }
  ...
  dispose() {
    ...
    this.detach();
    Common.Settings.Settings.instance().moduleSetting("persistenceNetworkOverridesEnabled").removeChangeListener(this.onNetworkPersistenceChanged, this);
  }
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["ToolbarItemsChanged"] = "ToolbarItemsChanged";
  return Events2;
})(Events || {});

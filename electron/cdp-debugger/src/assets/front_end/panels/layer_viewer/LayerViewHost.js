...
export class ScrollRectSelection extends Selection {
  ...
  isEqual(other) {
    return other.typeInternal === "ScrollRect" /* ScrollRect */ && this.layer().id() === other.layer().id() && this.scrollRectIndex === other.scrollRectIndex;
  }
}
export class SnapshotSelection extends Selection {
  ...
  isEqual(other) {
    return other.typeInternal === "Snapshot" /* Snapshot */ && this.layer().id() === other.layer().id() && this.snapshotInternal === other.snapshotInternal;
  }
  snapshot() {
...
export class LayerViewHost {
  ...
  constructor() {
    ...
    this.showInternalLayersSettingInternal = Common.Settings.Settings.instance().createSetting("layersShowInternalLayers", false);

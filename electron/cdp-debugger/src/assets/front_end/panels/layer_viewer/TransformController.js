...
export class TransformController extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(element, disableRotate) {
    ...
    resetButton.addEventListener(UI.Toolbar.ToolbarButton.Events.Click, this.resetAndNotify.bind(this, void 0));
  ...
  onScale(scaleFactor, x, y) {
    scaleFactor = Platform.NumberUtilities.clamp(this.scaleInternal * scaleFactor, this.minScale, this.maxScale) / this.scaleInternal;
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["TransformChanged"] = "TransformChanged";
  return Events2;
})(Events || {});
export var Modes = /* @__PURE__ */ ((Modes2) => {
  Modes2["Pan"] = "Pan";

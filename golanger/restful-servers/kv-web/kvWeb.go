...
func homePage(w http.ResponseWriter, r *http.Request) {
	...
	// The template.Must() function is a helper function
	// which makes sure that the template file provided contains no errors.
	myT := template.Must(template.ParseGlob("home.gohtml"))
	myT.ExecuteTemplate(w, "home.gohtml", nil)
}

/*
The listAll() function does not use any Go templates for generating its dynamic output.
Instead, its output is generated on the fly.
 */
